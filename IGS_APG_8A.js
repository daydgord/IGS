...
function updateHMI(ID) {
	...
	if(thisDryer){
		...
		document.getElementById(FurnaceID + '_DRY_CONTROLS_EXCHGINTEMP').innerHTML = decAdj(ModbusData[ID].EX_IN,1,0) + " °C";
		document.getElementById(FurnaceID + '_DRY_CONTROLS_EXCHGSP').innerHTML = decAdj(ModbusData[ID].EX_OUT,1,0) + " °C";
		document.getElementById(FurnaceID + '_DRY_CONTROLS_DRYERINTEMP').innerHTML = decAdj(ModbusData[ID].DRY_IN,1,0) + " °C";
		document.getElementById(FurnaceID + '_DRY_CONTROLS_DRYERSP').innerHTML = decAdj(ModbusData[ID].DRY_OUT,1,0) + " °C";
