				...
				if (this.readyState == 4) {
					if (this.status == 200) {
						if (this.responseXML != null) {
							...
							if(parseInt(ModbusData[0].FAN_1_SPEED)<3){ModbusData[0].FAN_1_SPEED = 0;};
							ModbusData[0].FAN_2_SPEED = this.responseXML.getElementsByTagName('fanBspeed')[0].childNodes[0].nodeValue;
							if(parseInt(ModbusData[0].FAN_2_SPEED)<3){ModbusData[0].FAN_2_SPEED = 0;};
...
function setFanSpeed(FurnaceID,FanNumber,ID){
	...
	if(fanFault){
		if(FanNumber == 1){
			fanSpeeds = 0;
			document.getElementById(FurnaceID + '_FAN_' + FanNumber + '_BOX_MIDDLE').innerText = "0%";
			};
		if(FanNumber == 2){
			fanSpeeds = 0;
			document.getElementById(FurnaceID + '_FAN_' + FanNumber + '_BOX_MIDDLE').innerText = "0%";
		...
		if(FanNumber == 1){
			...
			document.getElementById(FurnaceID + '_FAN_' + FanNumber + '_BOX_MIDDLE').innerText = ModbusData[ID].FAN_1_SPEED + "%";
			};
		if(FanNumber == 2){
			fanSpeeds = ModbusData[ID].FAN_2_SPEED;
			document.getElementById(FurnaceID + '_FAN_' + FanNumber + '_BOX_MIDDLE').innerText = ModbusData[ID].FAN_2_SPEED + "%";
		};
...
function updateHMI(ID) {
	...
	if(thisFlowRate){document.getElementById(FurnaceID + '_HMI_CONTROLS_GASFLOW').innerHTML = decAdj(ModbusData[ID].GAS_FLOW_PV,10,1) + " Ltr/h";};
	if(thisDryer){
		var calcSpeed = 0;
		...
		document.getElementById(FurnaceID + '_DRY_CONTROLS_EXCHGINTEMP').innerHTML = ModbusData[ID].EX_IN + " °C";
		document.getElementById(FurnaceID + '_DRY_CONTROLS_EXCHGSP').innerHTML = ModbusData[ID].EX_OUT + " °C";
		document.getElementById(FurnaceID + '_DRY_CONTROLS_DRYERINTEMP').innerHTML = ModbusData[ID].DRY_IN + " °C";
		...
		if(ModbusData[ID].DRY_FAN_FAULT){
			document.getElementById(FurnaceID + '_DRYER_FAN_BOX_BOT').innerText = ModbusData[ID].DRY_SPEED + " %";
...
function createHMIControls(ParentDivName,FurnaceID,IncludeDips){
	...
	if(thisFlowRate){HMI_CONTROLS_GASFLOW_LABEL.setAttribute('class','HMI_BLOCK HMI_CONT_GASFLOW');}
		else
		{HMI_CONTROLS_GASFLOW_LABEL.setAttribute('class','HMI_BLOCK HMI_CONT_DATA');};
...
function createHMISections(ParentDivName,BurnerCount,FurnaceID){
	...
	for(var i=0;i<(BurnerCount/2);i++){
		var HeightVal = 30;  //90/(BurnerCount/2);
		...
		switch (BurnerCount/2){
			case 4:
				...
				if(i==1){
					...
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','B' + 4,'100%',HeightVal + '%',true)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','B' + 2,'100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','B' + 4,'100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
				};
				if(i==2){
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_LEFT_TOP','A' + 1,'100%',HeightVal + '%',false)
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','A' + 3,'100%',HeightVal + '%',true)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','A' + 1,'100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','A' + 3,'100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
				};
				if(i==3){
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_LEFT_TOP','A' + 2,'100%',HeightVal + '%',false)
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','A' + 4,'100%',HeightVal + '%',true)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','A' + 2,'100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','A' + 4,'100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
				};
				break;
				case 2:
				if(i==0){
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_LEFT_TOP','B' + 1,'100%',HeightVal + '%',false)
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','B' + 2,'100%',HeightVal + '%',true)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','B' + 1,'100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','B' + 2,'100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
				};
				if(i==1){
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_LEFT_TOP','A' + 1,'100%',HeightVal + '%',false)
					createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','A' + 2,'100%',HeightVal + '%',true)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','A' + 1,'100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
					createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','A' + 2,'100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
				};
				break;
		};	
	};
...
function createFanGroup(FurnaceID,ParentDivName,ID){
	...
	var FAN_BOX_MIDDLE = document.createElement('div');
	...
	FAN_BOX_MIDDLE.setAttribute('id',FurnaceID + '_FAN_' + ID + '_BOX_MIDDLE');
	FAN_BOX_MIDDLE.setAttribute('class','FAN_BOX_MIDDLE');
	...
	FAN_BOX.appendChild(FAN_BOX_MIDDLE);
...
function createFlameGroupSpacer(FurnaceID,HeightVal,SpacerCount){
	...
	var HeightCalc = HeightVal * SpacerCount + 0;
...
function createBurnerGroup(FurnaceID,ParentDiv,ID,WidthVal,HeightVal,Reversed){
	...
	var GROUP_AIR_3B = document.createElement("div");
	...
	if(ID.includes("A")){
		GROUP_AIR_1.setAttribute('class','GROUP_AIR_1A');
	}else{
	...
	GROUP_AIR_3B.setAttribute('id',FurnaceID + '_' + ID + '_GROUP_AIR_3B');
	GROUP_AIR_3B.setAttribute('class','GROUP_AIR_3B');
	if(Reversed){
		...
		GROUP_AIR_3B.setAttribute('style','left:unset;');
	}else{
		...
		GROUP_AIR_3B.setAttribute('style','right:unset;');
	};
