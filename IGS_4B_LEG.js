...
function updateHMI(ID) {
	...
	setBurnerGroup(FurnaceID,'4',ModbusData[ID].B2_PVALVE,ModbusData[ID].B2_SGAS,ModbusData[ID].B2_FAULT)
...
function createHMISections(ParentDivName,BurnerCount,FurnaceID){
	...
	for(var i=0;i<(BurnerCount/2);i++){
		...
		if(i==BurnerCalc){
			...
			if(i==0){
				createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_LEFT_TOP','4','100%',HeightVal + '%',false)
				createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','3','100%',HeightVal + '%',true)
				createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','4','100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
				createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','3','100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
			} else {
				createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_LEFT_TOP','1','100%',HeightVal + '%',false)
				createBurnerGroup(FurnaceID,FurnaceID + '_HMI_SECTION_RIGHT_TOP','2','100%',HeightVal + '%',true)
				createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_LEFT','1','100%',HeightVal3 + '%',HeightVal2 + '%',false,BackWrapper)
				createFlameGroup(FurnaceID,FurnaceID + '_HMI_SECTION_MIDDLE_TOP_RIGHT','2','100%',HeightVal3 + '%',HeightVal2 + '%',true,false)
...
function createBurnerGroup(FurnaceID,ParentDiv,ID,WidthVal,HeightVal,Reversed){
	...
	if(ID==1||ID==2){GROUP_C1_BOT.appendChild(GROUP_AIR_3B);};
	if(Reversed){		
